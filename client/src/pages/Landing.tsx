    ...
    <div className="bg-[#fcfaf9] text-[#2c1810] selection:bg-[#4a2c20] selection:text-white font-sans antialiased overflow-x-hidden">
      ...
      <nav className="fixed top-0 left-0 w-full z-50 px-8 py-6 flex justify-between items-center bg-gradient-to-b from-[#fcfaf9] to-transparent">
        ...
        <div className="hidden md:flex gap-8 text-[10px] uppercase tracking-[0.2em] font-medium text-[#4a2c20]">
          <a href="#problem" className="hover:text-[#634235] transition-colors" data-testid="link-nav-problem">Problem</a>
      ...
      <ParallaxSection speed={0.1} className="bg-[#fcfaf9]">
        <div className="max-w-4xl">
          ...
          >
            ...
            <p className="text-sm md:text-base text-[#634235] mb-16 max-w-xl font-light leading-relaxed italic" data-testid="text-hero-supporting">
            ...
            <div className="flex flex-col sm:flex-row gap-8">
              ...
              <Button 
                variant="ghost" 
                className="rounded-none text-[#634235] hover:text-[#2c1810] hover:bg-transparent px-10 py-7 text-[10px] uppercase tracking-[0.2em] h-auto flex gap-3 items-center group transition-all"
      ...
      {/* Problem Statement */}
      <ParallaxSection id="problem" speed={0.08} className="bg-[#2c1810] text-[#fcfaf9] border-y border-[#3d2b24]">
        <div className="grid md:grid-cols-2 gap-24 items-start">
          ...
          <div className="space-y-10 text-[#d7ccc8] font-light leading-relaxed text-lg md:text-xl">
            ...
            <p className="pt-12 border-t border-[#3d2b24]">
      ...
      <ParallaxSection id="vision" speed={0.12} className="bg-[#fcfaf9]">
        <div className="max-w-4xl">
          ...
          <div className="space-y-8 text-[#4a2c20] text-xl font-light leading-relaxed">
            ...
            <p>
              The goal is not to simplify econometrics away, but to make correct inference <span className="text-[#2c1810] underline underline-offset-8 decoration-[#d7ccc8]">usable, inspectable, and explorable.</span>
            </p>
          </div>
        </div>
      </ParallaxSection>
        ...
        <ParallaxSection speed={0.04} className="border-b border-[#e5e0dd]">
          <div className="flex flex-col md:flex-row gap-16 md:gap-32">
            <div className="md:w-1/3">
              ...
              <p className="text-[10px] uppercase tracking-[0.4em] text-[#634235] font-semibold">Data Structure</p>
            </div>
          ...
          <div className="flex flex-col md:flex-row gap-16 md:gap-32">
            ...
            <div className="md:w-2/3">
              ...
              <ul className="grid grid-cols-1 sm:grid-cols-2 gap-y-6 text-[#634235] font-light text-lg">
                ...
                <li className="flex items-center gap-4"><span className="w-2 h-2 bg-[#2c1810]" /> Model Diagnostics</li>
        ...
        <ParallaxSection speed={0.04} className="bg-[#2c1810] text-[#fcfaf9]">
          <div className="flex flex-col md:flex-row gap-16 md:gap-32">
            ...
            <div className="md:w-2/3 space-y-8">
              ...
              <p className="text-base text-[#d7ccc8] italic bg-[#3d2b24] p-8 border-l-2 border-[#4a2c20] leading-relaxed">
      ...
      <ParallaxSection speed={0.08} className="bg-[#fcfaf9] py-48 border-t border-[#e5e0dd]">
        <div className="max-w-5xl">
          <h2 className="text-4xl md:text-6xl font-serif mb-24 text-[#2c1810]" data-testid="text-different-headline">
          ...
          <div className="grid sm:grid-cols-2 gap-16">
            {[
              ...
              <div key={i} className="flex gap-8 items-start">
                <item.icon className="w-8 h-8 text-[#634235] mt-1 shrink-0" strokeWidth={1.5} />
                <p className="text-2xl font-light text-[#4a2c20] leading-tight">{item.text}</p>
              </div>
            ))}
          </div>
          <div className="mt-32 pt-16 border-t border-[#e5e0dd]">
            <p className="text-2xl md:text-3xl font-serif italic text-[#634235] leading-relaxed">
      ...
      {/* Use Cases */}
      <section className="bg-[#2c1810] text-[#fcfaf9] py-48 px-6 md:px-24">
      ...
      <ParallaxSection speed={0.06} className="bg-[#fcfaf9]">
        <div className="max-w-4xl">
          <span className="text-[10px] uppercase tracking-[0.4em] text-[#634235] font-bold block mb-16">The Interrogation</span>
          <div className="space-y-16">
            {[
              ...
              <div key={i} className="flex gap-12 items-start border-b border-[#e5e0dd] pb-12 last:border-0" data-testid={`text-question-${i}`}>
                <span className="text-[#2c1810] font-serif italic text-3xl">0{i+1}</span>
      ...
      {/* Intended Impact */}
      <ParallaxSection id="impact" speed={0.04} className="bg-[#2c1810] text-[#fcfaf9] border-y border-[#3d2b24]">
      ...
      <footer className="bg-[#fcfaf9] py-48 px-6 md:px-24">
        <div className="max-w-6xl mx-auto flex flex-col items-center">
          ...
          <div className="flex flex-col md:flex-row justify-between w-full pt-32 border-t border-[#e5e0dd] gap-16">
            ...
            <div className="flex flex-wrap gap-12 text-[10px] uppercase tracking-[0.4em] font-medium text-[#634235]">
              ...
              <a href="#" className="hover:text-[#2c1810] transition-colors">Technical Brief</a>
            </div>
          </div>
        </div>
      </footer>
